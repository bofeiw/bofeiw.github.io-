    ...
    var t = {
        ...
        r = function () {
            ...
            var n = /^#?([a-f\d])([a-f\d])([a-f\d])$/i, t = t.replace(n, function (t, n, e, r) {
                    return n + n + e + e + r + r
                }), e = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t), r = parseInt(e[1], 16), a = parseInt(e[2], 16),
                u = parseInt(e[3], 16);
            return "rgb(" + r + "," + a + "," + u + ")"
        }, g = function (t) {
            var n, e, r, t = /hsl\((\d+),\s*([\d.]+)%,\s*([\d.]+)%\)/g.exec(t), a = parseInt(t[1]) / 360,
                u = parseInt(t[2]) / 100, i = parseInt(t[3]) / 100, o = function (t, n, e) {
                    return 0 > e && (e += 1), e > 1 && (e -= 1), 1 / 6 > e ? t + 6 * (n - t) * e : .5 > e ? n : 2 / 3 > e ? t + (n - t) * (2 / 3 - e) * 6 : t
                };
            if (0 == u) n = e = r = i; else var s = .5 > i ? i * (1 + u) : i + u - i * u;
            var c = 2 * i - s;
            ...
            var a = {};
            if ("transform" === e) a.from = t + "(" + b(t, n.from, n.to) + ")", a.to = t + "(" + b(t, n.to) + ")"; else {
